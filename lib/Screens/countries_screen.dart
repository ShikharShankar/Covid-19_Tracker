...
class CountriesInfoScreen extends StatefulWidget {
  ...
  const CountriesInfoScreen({Key? key,required this.countryVirusData}) : super(key: key);

  @override
  _CountriesInfoScreenState createState() => _CountriesInfoScreenState();
}

class _CountriesInfoScreenState extends State<CountriesInfoScreen> {
  late CountryVirusData locationData;
